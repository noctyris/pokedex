...
const DATA = [
  {id: `pkmn-${nanoid()}`, name: "Bulbizarre", num: "1", types: ["Plante","Poison"], category: "Graine", location: "bulbizarre.jpg"},
...
const truc =[// {id: `pkmn-${nanoid()}`, name: "Méga-Florizarre", num: "3", types: ["Plante","Poison"], category: "Graine", location: ""},
  // {id: `pkmn-${nanoid()}`, name: "Florizarre Gigamax", num: "3", types: ["Plante","Poison"], category: "Graine", location: ""},
  {id: `pkmn-${nanoid()}`, name: "Salamèche", num: "4", types: ["Feu"], category: "Lézard", location: ""},
  {id: `pkmn-${nanoid()}`, name: "Reptincel", num: "5", types: ["Feu"], category: "Flamme", location: ""},
  {id: `pkmn-${nanoid()}`, name: "Dracaufeu", num: "6", types: ["Feu","Vol"], category: "Flamme", location: ""},
  ...
  {id: `pkmn-${nanoid()}`, name: "Brutalibré", num: "701", types: ["Combat","Vol"], category: "Catcheur", location: ""},
